...
#define  TIME_TO_GET_TO_OTHER_SIDE            1


int    MaxMsgsToSimulate = 100;   // number of msgs to generate, then stop 
double LossProb = 0.1;                // probability that a packet is dropped  
double CorruptProb = 0.1;             // probability that packet has been damaged 
double OutOfOrderProb = 0.1;          // probability that packets may be out of order 
double AveTimeBetweenMsgs = 10000;     // Average time between messages from layer 5 
int    TraceLevel = 2;          // Defines the default level of debugging 
int    RandomizationRequested = 0;  // Should results be randomized or repeatable 
